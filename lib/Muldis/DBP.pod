...
This document is Muldis.DBP version 0.1.0.-9 for .Net.
...
the B<Muldis DBP> (B<MDBP>) library API for .Net.

The fully-qualified name of this document and the library API specification
it contains is C<Muldis_DBP_DotNet 'http://muldis.com' '0.1.0.-9'>.  It is
...
The Muldis DBP specification for .Net is expressly designed
...
Iff .Net libraries that implement the MDBP choose to explicitly support
...
example .Net library implementing it, where ...>
...
These existing or prospective .Net libraries implement at least 1 version
of the B<Muldis DBP> API: C<Muldis.D.Ref_Eng>, and so on.
...
should have received a copy of the AL2 as part of the MDBP distribution,
