...
This document is Muldis.DBP version 0.1.0.-9 for C#/.Net.
...
the B<Muldis DBP> (B<MDBP>) library API for C#/.Net.

The fully-qualified name of this document and the library API specification
it contains is C<Muldis_DBP_CSharp 'http://muldis.com' '0.1.0.-9'>.  It is
...
The Muldis DBP specification for C#/.Net is expressly designed
...
Iff C#/.Net libraries that implement the MDBP choose to explicitly support
...
example C#/.Net library implementing it, where ...>
...
These existing or prospective C#/.Net libraries implement at least 1 version
